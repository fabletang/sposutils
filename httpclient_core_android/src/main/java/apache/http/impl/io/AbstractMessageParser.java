...
import apache.http.message.BasicLineParser;
 ...
 * an instance of {@link apache.http.io.SessionInputBuffer}.
 *
 * @since 4.0
 */
...
public abstract class AbstractMessageParser<T extends HttpMessage> implements HttpMessageParser<T> {
    ...
    private final apache.http.config.MessageConstraints messageConstraints;
     ...
     *   LineParser, apache.http.config.MessageConstraints)}
     */
    @Deprecated
    public AbstractMessageParser(
        ...
        this.messageConstraints = apache.http.params.HttpParamConfig.getMessageConstraints(params);
    ...
    public AbstractMessageParser(
        ...
        this.messageConstraints = constraints != null ? constraints : apache.http.config.MessageConstraints.DEFAULT;
        this.headerLines = new ArrayList<CharArrayBuffer>();
        this.state = HEAD_LINE;
    }
