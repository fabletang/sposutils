...
/**
 * Default factory for {@link apache.http.HttpClientConnection}s.
 *
 * @since 4.3
 */
@Immutable
public class DefaultBHttpClientConnectionFactory
    ...
    private final apache.http.io.HttpMessageWriterFactory<HttpRequest> requestWriterFactory;
    private final apache.http.io.HttpMessageParserFactory<HttpResponse> responseParserFactory;

    public DefaultBHttpClientConnectionFactory(
            final ConnectionConfig cconfig,
            final ContentLengthStrategy incomingContentStrategy,
            final ContentLengthStrategy outgoingContentStrategy,
            final apache.http.io.HttpMessageWriterFactory<HttpRequest> requestWriterFactory,
            final apache.http.io.HttpMessageParserFactory<HttpResponse> responseParserFactory) {
        super();
