...
public class DefaultHttpResponseParser extends AbstractMessageParser<HttpResponse> {
     ...
     *
     * @deprecated (4.3) use
     *   {@link DefaultHttpResponseParser#DefaultHttpResponseParser(apache.http.io.SessionInputBuffer, LineParser,
     *     HttpResponseFactory, apache.http.config.MessageConstraints)}
     */
    @Deprecated
