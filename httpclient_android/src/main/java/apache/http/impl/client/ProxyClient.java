...
public class ProxyClient {
    ...
    private final apache.http.impl.auth.HttpAuthenticator authenticator;
    ...
    public ProxyClient(
        ...
        super();
        this.connFactory = connFactory != null ? connFactory : apache.http.impl.conn.ManagedHttpClientConnectionFactory.INSTANCE;
        ...
        this.authenticator = new apache.http.impl.auth.HttpAuthenticator();
        ...
        this.authSchemeRegistry.register(AuthSchemes.NTLM, new apache.http.impl.auth.NTLMSchemeFactory());
