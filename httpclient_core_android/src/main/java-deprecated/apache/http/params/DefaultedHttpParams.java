...
import apache.http.params.*;
import apache.http.params.HttpParamsNames;
import apache.http.util.Args;

/**
 * {@link apache.http.params.HttpParams} implementation that delegates resolution of a parameter
 * to the given default {@link apache.http.params.HttpParams} instance if the parameter is not
...
public final class DefaultedHttpParams extends AbstractHttpParams {
    ...
    private Set<String> getNames(final HttpParams params) {
        if (params instanceof apache.http.params.HttpParamsNames) {
