...
import apache.http.message.BasicHeaderValueFormatter;
...
import apache.http.message.BasicHeaderValueParser;
import apache.http.message.ParserCursor;
import apache.http.util.Args;
import apache.http.util.TextUtils;
