 ...
 * </p>
 * {@link #writeLine(apache.http.util.CharArrayBuffer)} and {@link #writeLine(String)} methods
 * of this class use CR-LF as a line delimiter.
 *
 * @since 4.3
 */
@NotThreadSafe
public class SessionOutputBufferImpl implements SessionOutputBuffer, apache.http.io.BufferInfo {
