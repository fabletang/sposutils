...
/**
 * Default factory for {@link apache.http.HttpServerConnection}s.
 *
 * @since 4.3
 */
@Immutable
public class DefaultBHttpServerConnectionFactory
    ...
    private final apache.http.io.HttpMessageParserFactory<HttpRequest> requestParserFactory;
    private final apache.http.io.HttpMessageWriterFactory<HttpResponse> responseWriterFactory;
