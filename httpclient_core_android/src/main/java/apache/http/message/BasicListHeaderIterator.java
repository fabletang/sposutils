 ...
 * @since 4.0
 */
@apache.http.annotation.NotThreadSafe
public class BasicListHeaderIterator implements HeaderIterator {
    ...
    public BasicListHeaderIterator(final List<Header> headers, final String name) {
        super();
        this.allHeaders = apache.http.util.Args.notNull(headers, "Header list");
    ...
    public void remove()
        ...
        apache.http.util.Asserts.check(this.lastIndex >= 0, "No header to remove");
