 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link apache.http.impl.conn.PoolingHttpClientConnectionManager}.
 */
@Deprecated
@ThreadSafe
public class DefaultClientConnectionOperator implements ClientConnectionOperator {
    ...
    public DefaultClientConnectionOperator(final SchemeRegistry schemes) {
        ...
        this.dnsResolver = new apache.http.impl.conn.SystemDefaultDnsResolver();
    }
    ...
    */
     ...
     *
     * @see DnsResolver
     * @see apache.http.impl.conn.SystemDefaultDnsResolver
     *
     * @since 4.1
     */
