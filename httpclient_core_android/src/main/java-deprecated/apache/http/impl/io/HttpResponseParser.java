 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link apache.http.impl.io.DefaultHttpResponseParser}
 */
@Deprecated
@NotThreadSafe
public class HttpResponseParser extends AbstractMessageParser<HttpMessage> {
     ...
     *    {@link apache.http.HttpResponse}s.
