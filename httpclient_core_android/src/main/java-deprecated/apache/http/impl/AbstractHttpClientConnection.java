...
import apache.http.impl.HttpConnectionMetricsImpl;
import apache.http.HttpClientConnection;
import apache.http.HttpConnectionMetrics;
...
import apache.http.impl.entity.LaxContentLengthStrategy;
import apache.http.impl.entity.StrictContentLengthStrategy;
import apache.http.impl.io.DefaultHttpResponseParser;
import org.apache.http.impl.io.HttpRequestWriter;
import apache.http.io.EofSensor;
import apache.http.io.HttpMessageParser;
import apache.http.io.HttpMessageWriter;
import apache.http.io.HttpTransportMetrics;
import apache.http.io.SessionInputBuffer;
import apache.http.io.SessionOutputBuffer;
 ...
 * class:
 * <ul>
 *  <li>{@link apache.http.params.CoreProtocolPNames#STRICT_TRANSFER_ENCODING}</li>
 *  <li>{@link apache.http.params.CoreConnectionPNames#MAX_HEADER_COUNT}</li>
 *  <li>{@link apache.http.params.CoreConnectionPNames#MAX_LINE_LENGTH}</li>
 * </ul>
 *
 * @since 4.0
 *
 * @deprecated (4.3) use {@link apache.http.impl.DefaultBHttpClientConnection}
 */
@NotThreadSafe
@Deprecated
public abstract class AbstractHttpClientConnection implements HttpClientConnection {
     ...
     * {@link apache.http.entity.ContentLengthStrategy}.
     *
    ...
    /**
     * Creates an instance of {@link apache.http.impl.DefaultHttpResponseFactory} to be used
     ...
     * {@link apache.http.message.LineParser} to the the
     ...
     * {@link apache.http.message.LineFormatter} to the the default implementation
