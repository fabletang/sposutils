...
import apache.http.impl.io.DefaultHttpRequestWriterFactory;
import apache.http.io.HttpMessageParser;
import apache.http.io.HttpMessageParserFactory;
import apache.http.io.HttpMessageWriter;
import apache.http.io.HttpMessageWriterFactory;
...
public class DefaultBHttpClientConnection extends BHttpConnectionBase
     ...
     *   {@link apache.http.impl.entity.LaxContentLengthStrategy#INSTANCE} will be used.
     ...
     *   {@link apache.http.impl.io.DefaultHttpResponseParserFactory#INSTANCE} will be used.
     */
    public DefaultBHttpClientConnection(
        ...
        this.responseParser = (responseParserFactory != null ? responseParserFactory :
            apache.http.impl.io.DefaultHttpResponseParserFactory.INSTANCE).create(getSessionInputBuffer(), constraints);
    }
