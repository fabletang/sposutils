...
public class PoolingHttpClientConnectionManager
    ...
    private final apache.http.impl.conn.HttpClientConnectionOperator connectionOperator;
    ...
    public PoolingHttpClientConnectionManager(
        ...
        this.connectionOperator = new apache.http.impl.conn.HttpClientConnectionOperator(
    ...
    private String format(final apache.http.impl.conn.CPoolEntry entry) {
        final StringBuilder buf = new StringBuilder();
    ...
    public ConnectionRequest requestConnection(
        ...
        final Future<apache.http.impl.conn.CPoolEntry> future = this.pool.lease(route, state, null);
    ...
    protected HttpClientConnection leaseConnection(
            final Future<apache.http.impl.conn.CPoolEntry> future,
            final long timeout,
            final TimeUnit tunit) throws InterruptedException, ExecutionException, ConnectionPoolTimeoutException {
        final apache.http.impl.conn.CPoolEntry entry;
        try {
            ...
            return apache.http.impl.conn.CPoolProxy.newProxy(entry);
    ...
    public void releaseConnection(
        ...
        synchronized (managedConn) {
            final apache.http.impl.conn.CPoolEntry entry = apache.http.impl.conn.CPoolProxy.detach(managedConn);
            if (entry == null) {
                return;
            }
    ...
    public void connect(
        ...
        synchronized (managedConn) {
            final apache.http.impl.conn.CPoolEntry entry = apache.http.impl.conn.CPoolProxy.getPoolEntry(managedConn);
    ...
    static class InternalConnectionFactory implements ConnFactory<HttpRoute, ManagedHttpClientConnection> {
        ...
        InternalConnectionFactory(
            ...
            this.connFactory = connFactory != null ? connFactory :
                apache.http.impl.conn.ManagedHttpClientConnectionFactory.INSTANCE;
        }
