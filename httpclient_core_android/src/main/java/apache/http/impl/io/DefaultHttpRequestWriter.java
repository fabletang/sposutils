...
/**
 * HTTP request writer that serializes its output to an instance of {@link apache.http.io.SessionOutputBuffer}.
 *
 * @since 4.3
 */
@NotThreadSafe
public class DefaultHttpRequestWriter extends AbstractMessageWriter<HttpRequest> {
     ...
     *   {@link apache.http.message.BasicLineFormatter#INSTANCE}
     *   will be used.
     */
