...
import apache.http.impl.client.*;
import apache.http.impl.client.CloseableHttpClient;
import apache.http.impl.client.ProxyAuthenticationStrategy;
import apache.http.impl.client.TargetAuthenticationStrategy;
...
import apache.http.impl.auth.NTLMSchemeFactory;
...
import apache.http.impl.cookie.IgnoreSpecFactory;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link apache.http.impl.client.HttpClientBuilder}.
 */
@ThreadSafe
@Deprecated
public abstract class AbstractHttpClient extends CloseableHttpClient {
    ...
    public synchronized final RedirectStrategy getRedirectStrategy() {
        if (redirectStrategy == null) {
            redirectStrategy = new apache.http.impl.client.DefaultRedirectStrategy();
        }
