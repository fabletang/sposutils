...
package apache.http.impl.execchain;
...
import apache.http.impl.auth.HttpAuthenticator;
import apache.http.impl.conn.ConnectionShutdownException;
...
public class MainClientExec implements ClientExecChain {
    ...
    public CloseableHttpResponse execute(
        ...
        if (request instanceof HttpEntityEnclosingRequest) {
            apache.http.impl.execchain.RequestEntityProxy.enhance((HttpEntityEnclosingRequest) request);
        }
        ...
        if (execAware != null) {
            if (execAware.isAborted()) {
                connRequest.cancel();
                throw new apache.http.impl.execchain.RequestAbortedException("Request aborted");
            } else {
        ...
        try {
            ...
            throw new apache.http.impl.execchain.RequestAbortedException("Request aborted", interrupted);
        } catch(final ExecutionException ex) {
            Throwable cause = ex.getCause();
            if (cause == null) {
                cause = ex;
            }
            throw new apache.http.impl.execchain.RequestAbortedException("Request execution failed", cause);
        }
        ...
        try {
            ...
            for (int execCount = 1;; execCount++) {
                ...
                if (execCount > 1 && !apache.http.impl.execchain.RequestEntityProxy.isRepeatable(request)) {
                ...
                if (!managedConn.isOpen()) {
                    ...
                    } catch (final apache.http.impl.execchain.TunnelRefusedException ex) {
            ...
            if (entity == null || !entity.isStreaming()) {
                ...
                return new apache.http.impl.execchain.HttpResponseProxy(response, null);
            } else {
                return new apache.http.impl.execchain.HttpResponseProxy(response, connHolder);
            }
    ...
    private boolean createTunnelToTarget(
        ...
        if (status > 299) {
            ...
            managedConn.close();
            throw new apache.http.impl.execchain.TunnelRefusedException("CONNECT refused by proxy: " +
