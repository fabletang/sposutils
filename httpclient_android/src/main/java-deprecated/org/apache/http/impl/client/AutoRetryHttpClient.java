...
import apache.http.impl.client.DefaultServiceUnavailableRetryStrategy;
...
public class AutoRetryHttpClient implements HttpClient {
     ...
     */
    public AutoRetryHttpClient() {
        this(new DefaultHttpClient(), new apache.http.impl.client.DefaultServiceUnavailableRetryStrategy());
    }
