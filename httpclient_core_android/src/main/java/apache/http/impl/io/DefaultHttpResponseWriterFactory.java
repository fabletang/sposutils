...
import apache.http.message.BasicLineFormatter;
import apache.http.message.LineFormatter;
 ...
 */
@Immutable
public class DefaultHttpResponseWriterFactory implements apache.http.io.HttpMessageWriterFactory<HttpResponse> {
