...
import apache.http.MalformedChunkCodingException;
import apache.http.TruncatedChunkException;
...
public class ChunkedInputStream extends InputStream {
    ...
    public int available() throws IOException {
        if (this.in instanceof apache.http.io.BufferInfo) {
            final int len = ((apache.http.io.BufferInfo) this.in).length();
