...
package apache.http.protocol;

import java.io.IOException;

import apache.http.entity.ByteArrayEntity;
import apache.http.ConnectionReuseStrategy;
...
import apache.http.HttpResponseFactory;
import apache.http.HttpServerConnection;
import apache.http.HttpStatus;
import apache.http.HttpVersion;
import apache.http.MethodNotSupportedException;
import apache.http.ProtocolException;
import apache.http.UnsupportedHttpVersionException;
import apache.http.annotation.Immutable;
import apache.http.impl.DefaultConnectionReuseStrategy;
import apache.http.impl.DefaultHttpResponseFactory;
import apache.http.params.HttpParams;
import apache.http.util.Args;
import apache.http.util.EncodingUtils;
 ...
 * <p/>
 * <tt>HttpService</tt> uses {@link apache.http.protocol.HttpRequestHandlerMapper} to map
...
public class HttpService {
    ...
    private volatile apache.http.protocol.HttpRequestHandlerMapper handlerMapper = null;
     ...
     *   HttpResponseFactory, apache.http.protocol.HttpRequestHandlerMapper, HttpExpectationVerifier)}
     */
    @Deprecated
    public HttpService(
     ...
     * @since 4.1
     * @deprecated (4.3) use {@link HttpService#HttpService(HttpProcessor, ConnectionReuseStrategy,
     *   HttpResponseFactory, apache.http.protocol.HttpRequestHandlerMapper)}
     */
    @Deprecated
    public HttpService(
            final HttpProcessor processor,
    ...
    public HttpService(
            ...
            final ConnectionReuseStrategy connStrategy,
            final HttpResponseFactory responseFactory,
            final apache.http.protocol.HttpRequestHandlerMapper handlerMapper,
            final HttpExpectationVerifier expectationVerifier) {
        super();
     ...
     */
    public HttpService(
            final HttpProcessor processor, final apache.http.protocol.HttpRequestHandlerMapper handlerMapper) {
     ...
     */
    @Deprecated
    private static class HttpRequestHandlerResolverAdapter implements apache.http.protocol.HttpRequestHandlerMapper {
