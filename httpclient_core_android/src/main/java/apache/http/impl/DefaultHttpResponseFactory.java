...
import apache.http.message.BasicHttpResponse;
import apache.http.message.BasicStatusLine;
...
import apache.http.ReasonPhraseCatalog;
 ...
 * @since 4.0
 */
@apache.http.annotation.Immutable
