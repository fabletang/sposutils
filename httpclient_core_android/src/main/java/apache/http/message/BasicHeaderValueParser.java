...
import apache.http.HeaderElement;
...
public class BasicHeaderValueParser implements HeaderValueParser {
    ...
    public static
        ...
        apache.http.util.Args.notNull(value, "Value");
    ...
    public HeaderElement[] parseElements(final CharArrayBuffer buffer,
        ...
        apache.http.util.Args.notNull(buffer, "Char array buffer");
        apache.http.util.Args.notNull(cursor, "Parser cursor");
