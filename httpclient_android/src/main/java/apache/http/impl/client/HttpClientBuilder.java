...
package apache.http.impl.client;
...
import apache.http.impl.auth.DigestSchemeFactory;
import apache.http.impl.auth.KerberosSchemeFactory;
import apache.http.impl.cookie.BrowserCompatSpecFactory;
import apache.http.impl.cookie.NetscapeDraftSpecFactory;
import apache.http.impl.cookie.RFC2109SpecFactory;
import apache.http.impl.cookie.RFC2965SpecFactory;
...
import apache.http.impl.auth.BasicSchemeFactory;
import apache.http.impl.auth.SPNegoSchemeFactory;
import apache.http.impl.cookie.BestMatchSpecFactory;
import apache.http.impl.execchain.ClientExecChain;
import apache.http.impl.execchain.ProtocolExec;
...
`     */
    ...
    public CloseableHttpClient build() {
        ...
        if (connManager == null) {
            ...
            final apache.http.impl.conn.PoolingHttpClientConnectionManager poolingmgr = new apache.http.impl.conn.PoolingHttpClientConnectionManager(
        ...
        ClientExecChain execChain = new apache.http.impl.execchain.MainClientExec(
                requestExec,
                connManager,
                reuseStrategy,
                keepAliveStrategy,
        ...
        if (!automaticRetriesDisabled) {
            ...
            execChain = new apache.http.impl.execchain.RetryExec(execChain, retryHandler);
        }
        ...
        if (routePlanner == null) {
            ...
            if (schemePortResolver == null) {
                schemePortResolver = apache.http.impl.conn.DefaultSchemePortResolver.INSTANCE;
            }
            if (proxy != null) {
                routePlanner = new apache.http.impl.conn.DefaultProxyRoutePlanner(proxy, schemePortResolver);
            } else if (systemProperties) {
                routePlanner = new apache.http.impl.conn.SystemDefaultRoutePlanner(
                        schemePortResolver, ProxySelector.getDefault());
            } else {
                routePlanner = new apache.http.impl.conn.DefaultRoutePlanner(schemePortResolver);
            }
        }
        ...
        if (!redirectHandlingDisabled) {
            ...
            execChain = new apache.http.impl.execchain.RedirectExec(execChain, routePlanner, redirectStrategy);
        }
        ...
        if (serviceUnavailStrategy != null) {
            execChain = new apache.http.impl.execchain.ServiceUnavailableRetryExec(execChain, serviceUnavailStrategy);
        }
        ...
        if (backoffManager != null && connectionBackoffStrategy != null) {
            execChain = new apache.http.impl.execchain.BackoffStrategyExec(execChain, connectionBackoffStrategy, backoffManager);
        }
        ...
        if (authSchemeRegistry == null) {
            authSchemeRegistry = RegistryBuilder.<AuthSchemeProvider>create()
                ...
                .register(AuthSchemes.NTLM, new apache.http.impl.auth.NTLMSchemeFactory())
        ...
        if (cookieSpecRegistry == null) {
            cookieSpecRegistry = RegistryBuilder.<CookieSpecProvider>create()
                ...
                .register(CookieSpecs.IGNORE_COOKIES, new apache.http.impl.cookie.IgnoreSpecFactory())
