...
import apache.http.protocol.HttpRequestHandler;
import apache.http.protocol.HttpRequestHandlerResolver;
import apache.http.protocol.UriPatternMatcher;
 ...
 * {@link apache.http.protocol.HttpRequestHandler} matching a particular request URI. Usually the
 * resolved request handler will be used to process the request with the
 * specified request URI.
 *
 * @since 4.0
 * @deprecated (4.3) use {@link apache.http.protocol.UriHttpRequestHandlerMapper}
 */
